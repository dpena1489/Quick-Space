...
function HouseSpace() {
  // TODO : Add logic to fetch our House Spaces data from Apollo using our defined userQuery

  return (
    <ShowListings pageTitle={"House Spaces"} listingData={HouseSpacesMockedData}/>
  );
}
